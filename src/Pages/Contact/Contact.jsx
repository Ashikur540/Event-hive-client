                    ...
                    <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        <div className="overflow-hidden bg-white dark:bg-opacity-10 rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900 dark:text-snow-white-toned">+1-316-555-0116</p>
                                <p className="mt-1 text-lg font-medium text-gray-900 dark:text-snow-white-toned">+1-446-526-0117</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white dark:bg-opacity-10 rounded-xl">
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium text-gray-900 dark:text-snow-white-toned" >contact@example.com</p>
                                <p className="mt-1 text-lg font-medium text-gray-900 dark:text-snow-white-toned">hr@example.com</p>
                            </div>
                        </div>
                        ...
                        <div className="overflow-hidden bg-white rounded-xl dark:bg-opacity-10" >
                            <div className="p-6">
                                ...
                                <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900 dark:text-snow-white-toned">8502 Preston Rd. Ingle, Maine 98380, USA</p>
                            </div>
                        </div>
                    </div>
