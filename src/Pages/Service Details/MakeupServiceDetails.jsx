                    ...
                    <div className="grid gap-8 lg:grid-cols-4 lg:items-start">
                        ...
                        <div className="lg:sticky lg:top-0">
                            <form className="space-y-4 lg:pt-8">
                                ...
                                <>
                                    <div>
                                        <h1 className="text-2xl font-bold lg:text-3xl dark:text-snow-white">{name}</h1>

                                        <p className="mt-1 text-sm text-gray-500 font-inter dark:text-snow-white-toned">Makeup Type: {Makeup_type}</p>
                                    </div>
                                </>

                                <div className="rounded border bg-gray-100 p-4">
                                    <p className="text-sm ">
                                        <span className="block dark:text-snow-white-toned"> Rating-❤{Rating}</span>
                                        <span className="block dark:text-snow-white-toned font-inter"> 📞 {contact}. </span>
