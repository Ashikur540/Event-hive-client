        ...
        <>
            {
                loading ? <Spinner />
                    ...
                    <aside
                        // ref={sidebar}
                        className={`fixed left-0 top-0 z-[9999]  flex h-screen   flex-col overflow-y-hidden  shadow-md shadow-slate-400  bg-white px-6 pb-3 duration-300 ease-linear dark:bg-dark-toned md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] lg:static lg:translate-x-0 ${sidebarOpen ? 'ml-[0%]' : '-ml-[100%]'}`
                        }
                    >
